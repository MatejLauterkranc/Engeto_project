...
def fetch_data(minlat, maxlat, minlon, maxlon):
    ...
    params = {
        ...
        'compact': True,
        'verbose': False,
        'key': 'd1613f8c-b100-465f-a020-9f800887a141'  # Tvůj API klíč
    }
...
def fetch_all_data_recursive(minlat, maxlat, minlon, maxlon, step=0.05, depth=0, max_depth=5):
    ...
    time.sleep(1)  # Pauza kvůli limitům API
...
def flatten_dict(d, parent_key='', sep='.'):
    ...
    for k, v in d.items():
        ...
        if isinstance(v, dict):
            ...
            # Pokud je položka list, převedeme na string (nebo můžeš upravit podle potřeby)
